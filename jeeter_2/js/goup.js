...
(function ( $ ) {
	...
	$.goup = function(user_params) {
		...
		$('body').append('<div style="display:none" class="'+params.containerClass+' hvr-bob"></div>');
		...
		$(window).resize(function(){
			if ($(window).outerWidth() <= params.hideUnderWidth) {
				...
				if (textContainer) do_animation($(textContainer), 'hide', params.entryAnimation);
			} else {
				isHidden = false;
