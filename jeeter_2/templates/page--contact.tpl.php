...
<div id="page-wrapper">
	...
	<div id="page">
						...
						<?php if ($logo): ?>
							<div id="logo">
								<a class="hvr-float-shadow" href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" rel="home">
									<img src="<?php print $logo; ?>" alt="<?php print t('Home'); ?>" class="mini-logo-img"/>
								</a>
							</div>
						<?php endif; ?>
						<?php if ($site_name || $site_slogan): ?>
							<div id="name-and-slogan">
								<?php if ($site_name): ?>
									<?php if ($title): ?>
										<div id="site-name">
											<h2><a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" rel="home"><span><?php print $site_name; ?></span></a></h2>
										</div>
			...
			<div id="main" class="clearfix">
				...
				<div id="content" class="column">
					...
					<div class="section">
						...
						<h3 class="contact-title">" Escríbenos. Estamos a tu disposición. "</h3>
		...
		<section class="contact-map">
			<h3 class="contact-title">¿ Donde estamos ?</h3>
...
<script>
	var myCenter=new google.maps.LatLng(39.56355828840298,-0.5333036184310913);
	var info_title = 'Titulo a especificar';
	var info_text = '<strong>Resaltado</strong>, y sigue el texto <br>que separo en<em>dos líneas</em>';
	function initialize(){
		var mapProp = {
			center:myCenter,
			zoom:17,
		...
		var marker=new google.maps.Marker({
			icon: 'sites/all/themes/jeeter/images/marker.png',
			position:myCenter,
		});
		marker.setMap(map);
		var infowindow = new google.maps.InfoWindow({
			content:"<h3>"+info_title+"</h3>"+info_text
		});
